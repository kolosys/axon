...
This documentation provides comprehensive guidance for using axon, a Go library designed to help you build better software.

## Project Information

- **Repository**: [https://github.com/kolosys/axon](https://github.com/kolosys/axon)
...
- **GitHub Issues**: [https://github.com/kolosys/axon/issues](https://github.com/kolosys/axon/issues)
- **Discussions**: [https://github.com/kolosys/axon/discussions](https://github.com/kolosys/axon/discussions)
...
3. Search existing [GitHub Issues](https://github.com/kolosys/axon/issues)
4. Open a new issue if you've found a bug or have a feature request

## Next Steps

Ready to get started? Head over to the [Installation Guide](installation.md) to begin using axon.
